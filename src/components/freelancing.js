...
const Freelancing = ({ data }) => (
  <Section className="freelancing" title={data.title}>
...
export const freelancingFragment = graphql`
  fragment Freelancing on ContentfulFreelancing {
    title
  }
`